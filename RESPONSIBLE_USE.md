...
## Passive OSINT Principles

This framework is designed for **passive OSINT only**:

- We query public search engines and APIs for openly available information
- We probe HTTP endpoints **only** to check response codes and public headers — never to exploit
